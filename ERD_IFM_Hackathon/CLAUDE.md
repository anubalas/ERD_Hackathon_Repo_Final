...
<!-- SPECKIT START -->
**Active feature**: `004-ai-agent-rag`

| Artifact | Path |
|----------|------|
| Spec | `specs/004-ai-agent-rag/spec.md` |
| Plan | `specs/004-ai-agent-rag/plan.md` |
| Research | `specs/004-ai-agent-rag/research.md` |
| Data Model | `specs/004-ai-agent-rag/data-model.md` |
| CLI Contract | `specs/004-ai-agent-rag/contracts/CLI_CONTRACT.md` |
| Quickstart | `specs/004-ai-agent-rag/quickstart.md` |
| Tasks | `specs/004-ai-agent-rag/tasks.md` *(generated by /speckit-tasks)* |
<!-- SPECKIT END -->

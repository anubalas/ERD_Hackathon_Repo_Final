...
<!-- SPECKIT START -->
**Active feature**: `003-anomaly-detection`

| Artifact | Path |
|----------|------|
| Spec | `specs/003-anomaly-detection/spec.md` |
| Plan | `specs/003-anomaly-detection/plan.md` |
| Research | `specs/003-anomaly-detection/research.md` |
| Data Model | `specs/003-anomaly-detection/data-model.md` |
| CLI Contract | `specs/003-anomaly-detection/contracts/CLI_CONTRACT.md` |
| Quickstart | `specs/003-anomaly-detection/quickstart.md` |
| Tasks | `specs/003-anomaly-detection/tasks.md` *(generated by /speckit-tasks)* |
<!-- SPECKIT END -->
